                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    {product.weight && (
                      <div className="flex">
                        ...
                        <span>{safeRender(product.weight)} kg</span>
                      </div>
                    )}
                    {product.dimensions && (
                      <>
                        <div className="flex">
                          ...
                          <span>{safeRender(product.dimensions.length)} cm</span>
                        </div>
                        <div className="flex">
                          <span className="font-medium w-32">Width:</span>
                          <span>{safeRender(product.dimensions.width)} cm</span>
                        </div>
                        <div className="flex">
                          <span className="font-medium w-32">Height:</span>
                          <span>{safeRender(product.dimensions.height)} cm</span>
                        </div>
                      </>
                    )}
                  </div>
